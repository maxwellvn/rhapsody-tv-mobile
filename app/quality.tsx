...
export default function QualityScreen() {
  ...
  useEffect(() => {
    if (settings) {
      setMobileQuality(settings.quality.videoQualityMobile as QualityOption);
      setWifiQuality(settings.quality.videoQualityWifi as QualityOption);
      setAudioQuality(settings.quality.audioQuality as AudioOption);
    }
  }, [settings]);
        ...
        >
          ...
          <View style={styles.descriptionContainer}>
            <Text style={styles.description}>
              Set your preferred streaming quality as your default setting for
              all videos. You can change streaming quality in player settings
              for each video
            </Text>
          </View>
          ...
          <SettingsSection>
            ...
            <SettingsItemRadio
              ...
              onPress={() => {
                setMobileQuality("higher");
                updateSettings({
                  quality: {
                    videoQualityMobile: "higher",
                  },
                });
              }}
            />
            <SettingsItemRadio
              ...
              onPress={() => {
                setMobileQuality("data-saver");
                updateSettings({
                  quality: {
                    videoQualityMobile: "data-saver",
                  },
                });
              }}
            />
          ...
          <SettingsSection>
            ...
            <SettingsItemRadio
              ...
              onPress={() => {
                setWifiQuality("higher");
                updateSettings({
                  quality: {
                    videoQualityWifi: "higher",
                  },
                });
              }}
            />
            <SettingsItemRadio
              ...
              onPress={() => {
                setWifiQuality("data-saver");
                updateSettings({
                  quality: {
                    videoQualityWifi: "data-saver",
                  },
                });
              }}
            />
